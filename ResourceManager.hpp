...
namespace MR{
    ...
    public:
         ...
         */
        Resource(MR::ResourceManager* manager, std::string name, std::string source) : _res_free_state(true), _name(name), _source(source), _resource_manager(manager), _loaded(false) {}
        virtual ~Resource(){}
    };
