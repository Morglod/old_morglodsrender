...
void ShaderProgram::SetUniform(const std::string& name, const int& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniform1i(_handle, glGetUniformLocation(_handle, name.c_str()), value);
...
void ShaderProgram::SetUniform(const std::string& name, const float& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniform1f(_handle, glGetUniformLocation(_handle, name.c_str()), value);
...
void ShaderProgram::SetUniform(const std::string& name, const glm::vec2& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniform2fv(_handle, glGetUniformLocation(_handle, name.c_str()), 2, &value.x);
...
void ShaderProgram::SetUniform(const std::string& name, const glm::vec3& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniform3fv(_handle, glGetUniformLocation(_handle, name.c_str()), 3, &value.x);
...
void ShaderProgram::SetUniform(const std::string& name, const glm::vec4& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniform4fv(_handle, glGetUniformLocation(_handle, name.c_str()), 4, &value.x);
...
void ShaderProgram::SetUniform(const std::string& name, const glm::mat4& value) {
    if(_handle) {
        if(MR::MachineInfo::IsDirectStateAccessSupported()) glProgramUniformMatrix4fv(_handle, glGetUniformLocation(_handle, name.c_str()), 1,  GL_FALSE, &value[0][0]);
